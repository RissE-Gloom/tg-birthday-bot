...
- **Интерактивный список:** Внедрена система просмотра дней рождений без тегов (Option 4). Список нумерованный, а профиль конкретного человека можно получить по его номеру.
